...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_ouvrageprotection_codealea_s','features','typeppr_codegaspar_ouvrageprotection_codealea_s','Table Ouvrage de protection Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,5490),
  ('typeppr_codegaspar_ouvrageprotection_codealea_l','features','typeppr_codegaspar_ouvrageprotection_codealea_l','Table Ouvrage de protection Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,5490),
  ('typeppr_codegaspar_ouvrageprotection_codealea_p','features','typeppr_codegaspar_ouvrageprotection_codealea_p','Table Ouvrage de protection Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,5490)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_ouvrageprotection_codealea_s','geom','MULTIPOLYGON',5490,0,0),
  ('typeppr_codegaspar_ouvrageprotection_codealea_l','geom','MULTILINESTRING',5490,0,0),
  ('typeppr_codegaspar_ouvrageprotection_codealea_p','geom','MULTIPOINT',5490,0,0)
 ;
