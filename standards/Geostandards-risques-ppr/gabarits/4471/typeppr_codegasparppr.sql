...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES 
  ('typeppr_codegaspar_perimetre_s','features','typeppr_codegaspar_perimetre_s','Table Perimetre Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns - exemple en EPSG:4471 */
INSERT INTO gpkg_geometry_columns VALUES 
  ('typeppr_codegaspar_perimetre_s','geom','MULTIPOLYGON',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeareference_codealea_s','features','typeppr_codegaspar_zonealeareference_codealea_s','Table Zone Alea de Reference Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeareference_codealea_s','geom','POLYGON',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeaecheance100ans_117_s','features','typeppr_codegaspar_zonealeaecheance100ans_117_s','Table Zone Alea Echéance 100 ans Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeaecheance100ans_117_s','geom','POLYGON',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeaexceptionnel_14_s','features','typeppr_codegaspar_zonealeaexceptionnel_14_s','Table Zone Alea Exceptionnel Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeaexceptionnel_14_s','geom','POLYGON',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zoneprotegee_codealea_s','features','typeppr_codegaspar_zoneprotegee_codealea_s','Table Zone Protégée Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zoneprotegee_codealea_s','geom','POLYGON',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonedangerspecifique_codealea_s','features','typeppr_codegaspar_zonedangerspecifique_codealea_s','Table Zone de danger Spécifique Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonedangerspecifique_codealea_s','geom','POLYGON',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_ouvrageprotection_codealea_s','features','typeppr_codegaspar_ouvrageprotection_codealea_s','Table Ouvrage de protection Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_ouvrageprotection_codealea_l','features','typeppr_codegaspar_ouvrageprotection_codealea_l','Table Ouvrage de protection Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_ouvrageprotection_codealea_p','features','typeppr_codegaspar_ouvrageprotection_codealea_p','Table Ouvrage de protection Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_ouvrageprotection_codealea_s','geom','MULTIPOLYGON',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_ouvrageprotection_codealea_l','geom','MULTILINESTRING',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_ouvrageprotection_codealea_p','geom','MULTIPOINT',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_originerisque_s','features','typeppr_codegaspar_originerisque_s','Table Origine du risque Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_originerisque_l','features','typeppr_codegaspar_originerisque_l','Table Origine du risque Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_originerisque_p','features','typeppr_codegaspar_originerisque_p','Table Origine du risque Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_originerisque_s','geom','MULTIPOLYGON',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_originerisque_l','geom','MULTILINESTRING',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_originerisque_p','geom','MULTIPOINT',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_enjeu_s','features','typeppr_codegaspar_enjeu_s','Table Enjeux Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_enjeu_l','features','typeppr_codegaspar_enjeu_l','Table Enjeux Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_enjeu_p','features','typeppr_codegaspar_enjeu_p','Table Enjeux Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_enjeu_s','geom','MULTIPOLYGON',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_enjeu_l','geom','MULTILINESTRING',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_enjeu_p','geom','MULTIPOINT',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonereglementaireurba_s','features','typeppr_codegaspar_zonereglementaireurba_s','Table Zone Réglementaire Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_zonereglementaireurba_l','features','typeppr_codegaspar_zonereglementaireurba_l','Table Zone Réglementaire Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_zonereglementaireurba_p','features','typeppr_codegaspar_zonereglementaireurba_p','Table Zone Réglementaire Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonereglementaireurba_s','geom','POLYGON',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_zonereglementaireurba_l','geom','LINESTRING',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_zonereglementaireurba_p','geom','POINT',/*srs_id*/4471,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:4471*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonereglementairefoncier_s','features','typeppr_codegaspar_zonereglementairefoncier_s','Table Zone Réglementaire Foncier Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_zonereglementairefoncier_l','features','typeppr_codegaspar_zonereglementairefoncier_l','Table Zone Réglementaire Foncier Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471),
  ('typeppr_codegaspar_zonereglementairefoncier_p','features','typeppr_codegaspar_zonereglementairefoncier_p','Table Zone Réglementaire Foncier Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/4471)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonereglementairefoncier_s','geom','POLYGON',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_zonereglementairefoncier_l','geom','LINESTRING',/*srs_id*/4471,0,0),
  ('typeppr_codegaspar_zonereglementairefoncier_p','geom','POINT',/*srs_id*/4471,0,0)
 ;
