...
INSERT INTO gpkg_contents VALUES 
  ('typeppr_codegaspar_perimetre_s','features','typeppr_codegaspar_perimetre_s','Table Perimetre Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns - exemple en EPSG:2154 */
INSERT INTO gpkg_geometry_columns VALUES 
  ('typeppr_codegaspar_perimetre_s','geom','MULTIPOLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES 
  ('typeppr_codegaspar_perimetreetude_s','features','typeppr_codegaspar_perimetreetude_s','Table PerimetreEtude Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns - exemple en EPSG:2154 */
INSERT INTO gpkg_geometry_columns VALUES 
  ('typeppr_codegaspar_perimetreetude_s','geom','MULTIPOLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeareference_codealea_s','features','typeppr_codegaspar_zonealeareference_codealea_s','Table Zone Alea de Reference Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeareference_codealea_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeaecheance100ans_117_s','features','typeppr_codegaspar_zonealeaecheance100ans_117_s','Table Zone Alea Echéance 100 ans Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeaecheance100ans_117_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeaexceptionnel_14_s','features','typeppr_codegaspar_zonealeaexceptionnel_14_s','Table Zone Alea Exceptionnel Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeaexceptionnel_14_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeanaturelsynthese_s','features','typeppr_codegaspar_zonealeanaturelsynthese_s','Table Zone Alea Naturel Synthese Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeanaturelsynthese_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeatechnorapide_codealea_s','features','typeppr_codegaspar_zonealeatechnorapide_codealea_s','Table Zone Alea Technologique Rapide Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeatechnorapide_codealea_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeatechnoprojection_214_s','features','typeppr_codegaspar_zonealeatechnoprojection_214_s','Table Zone Alea Technologique Projection Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeatechnoprojection_214_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonealeatechnosynthese_s','features','typeppr_codegaspar_zonealeatechnosynthese_s','Table Zone Alea Technologique Synthese Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonealeatechnosynthese_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zoneprotegee_codealea_s','features','typeppr_codegaspar_zoneprotegee_codealea_s','Table Zone Protégée Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zoneprotegee_codealea_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonedangerspecifique_codealea_s','features','typeppr_codegaspar_zonedangerspecifique_codealea_s','Table Zone de danger Spécifique Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonedangerspecifique_codealea_s','geom','POLYGON',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_ouvrageprotecteur_codealea_s','features','typeppr_codegaspar_ouvrageprotecteur_codealea_s','Table Ouvrage de protection Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_ouvrageprotecteur_codealea_l','features','typeppr_codegaspar_ouvrageprotecteur_codealea_l','Table Ouvrage de protection Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_ouvrageprotecteur_codealea_p','features','typeppr_codegaspar_ouvrageprotecteur_codealea_p','Table Ouvrage de protection Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_ouvrageprotecteur_codealea_s','geom','MULTIPOLYGON',4467,0,0),
  ('typeppr_codegaspar_ouvrageprotecteur_codealea_l','geom','MULTILINESTRING',4467,0,0),
  ('typeppr_codegaspar_ouvrageprotecteur_codealea_p','geom','MULTIPOINT',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_originerisque_s','features','typeppr_codegaspar_originerisque_s','Table Origine du risque Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_originerisque_l','features','typeppr_codegaspar_originerisque_l','Table Origine du risque Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_originerisque_p','features','typeppr_codegaspar_originerisque_p','Table Origine du risque Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_originerisque_s','geom','MULTIPOLYGON',4467,0,0),
  ('typeppr_codegaspar_originerisque_l','geom','MULTILINESTRING',4467,0,0),
  ('typeppr_codegaspar_originerisque_p','geom','MULTIPOINT',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_enjeu_s','features','typeppr_codegaspar_enjeu_s','Table Enjeux Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_enjeu_l','features','typeppr_codegaspar_enjeu_l','Table Enjeux Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_enjeu_p','features','typeppr_codegaspar_enjeu_p','Table Enjeux Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_enjeu_s','geom','MULTIPOLYGON',4467,0,0),
  ('typeppr_codegaspar_enjeu_l','geom','MULTILINESTRING',4467,0,0),
  ('typeppr_codegaspar_enjeu_p','geom','MULTIPOINT',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonereglementaireurba_s','features','typeppr_codegaspar_zonereglementaireurba_s','Table Zone Réglementaire Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_zonereglementaireurba_l','features','typeppr_codegaspar_zonereglementaireurba_l','Table Zone Réglementaire Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_zonereglementaireurba_p','features','typeppr_codegaspar_zonereglementaireurba_p','Table Zone Réglementaire Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonereglementaireurba_s','geom','POLYGON',4467,0,0),
  ('typeppr_codegaspar_zonereglementaireurba_l','geom','LINESTRING',4467,0,0),
  ('typeppr_codegaspar_zonereglementaireurba_p','geom','POINT',4467,0,0)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('typeppr_codegaspar_zonereglementairefoncier_s','features','typeppr_codegaspar_zonereglementairefoncier_s','Table Zone Réglementaire Foncier Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_zonereglementairefoncier_l','features','typeppr_codegaspar_zonereglementairefoncier_l','Table Zone Réglementaire Foncier Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467),
  ('typeppr_codegaspar_zonereglementairefoncier_p','features','typeppr_codegaspar_zonereglementairefoncier_p','Table Zone Réglementaire Foncier Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,4467)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('typeppr_codegaspar_zonereglementairefoncier_s','geom','POLYGON',4467,0,0),
  ('typeppr_codegaspar_zonereglementairefoncier_l','geom','LINESTRING',4467,0,0),
  ('typeppr_codegaspar_zonereglementairefoncier_p','geom','POINT',4467,0,0)
 ;
