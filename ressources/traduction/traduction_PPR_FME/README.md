...
Il génère en sortie un jeu de données selon le nouveau standard ([PPRN_result.gpkg](./PPRN_result.zip)) au format Geopackage (choix de format par défaut pour l'instant).
